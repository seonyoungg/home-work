...
업무에만 치중했던 Git명령어 사용이었는데 이제는 나아가 Git의 버전관리 시스템을 이해뿐만 아니라 Git에 대한 이해도도 넓어질 수 있었다고 생각한다.😉  
뿐만 아니라 HTML 문서를 작성하는 과정에서도 조금 더 의미있게 시멘틱마크업, 이미지 대체텍스트의 중요성 등을 다시금 깨닫는 과정이 되었고 이전에 작업했던 홈페이지들이 생각나면서 나는 과연 사용자를 고려한 코드를 짰었는가에 대한 반성을 해본다.

앞으로도 더욱 열심히 학습하면서 크나큰 성장을 하는 나를 기대해야지!❤️
